"""Config flow : trois champs, rien d'autre.

Le username n'est pas demande : il est deduit du token via /oauth/identity.
Les field_id des conditions sont resolus automatiquement au premier snapshot.
"""
        ...
        if user_input is not None:
            ...
            try:
                ...
                return self.async_create_entry(
                    title=f"Collection Discogs de {username}",
                    data={
...
class DiscogsValuationOptionsFlow(OptionsFlow):
    """Modification de l'intervalle et de la devise apres coup."""
